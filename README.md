...
## 🎯 Objetivo do Projeto
O sistema automatiza a coleta de feedbacks de atendimento ao cliente, processando dados de entrada (nome, idade e opinião) e gerando um relatório quantitativo de satisfação ao final do ciclo de entrevistas.
